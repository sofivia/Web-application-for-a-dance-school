...
from .views import MeView, AccountViewSet, RoleViewSet, EmailTokenObtainPairView, RegisterView
...
urlpatterns = [
    path("token/", EmailTokenObtainPairView.as_view(), name="accounts_token_obtain_pair"),
